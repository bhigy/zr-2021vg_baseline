# Based on https://github.com/bootphon/zerospeech2021_baseline/blob/master/scripts/build_LSTM_features.py
import os
import sys
import json
import argparse
...
from scripts.utils.utils_functions import writeArgs, loadLSTMLMCheckpoint
